...
<span id="result"></span>
<br> 
이름:<input type="text" name="username" id="username" value="${login.username }"><br> 
...
이메일:<input type="text" value="${login.email1 }" name="email1" id="email1">@
       ...
       <select  id="emailSelect">
        <option value="daum.net" <c:if test="${login.email2 eq 'daum.net' }" >selected</c:if>>daum.net</option>
