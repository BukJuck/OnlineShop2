...
//		System.out.println(map);
	...
	@ResponseBody
	public void cartDelete(int num) throws Exception{	//바로 int num으로 받아도 됨 key값이 ajax에서 넘어옴
...
//	@ResponseBody
//	public String delAllCart(String[] check) {	//requestParam("check") 생략
//		System.out.println(check.length);
//		return " ";
//	}
	
	@RequestMapping("/loginCheck/delAllCart")
	public String delAllCart(@RequestParam("check") ArrayList<String> check)throws Exception {	//requestParam("check") 생략안됨
//		System.out.println(check);
		Service.delAllCart(check);
