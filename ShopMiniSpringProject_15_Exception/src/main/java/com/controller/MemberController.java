...
//		System.out.println(m);
	...
	public String mypage(HttpSession session) throws Exception{	//main에서 왔으니 session 에 로그인 정보가 담겨있음.
...
//	} //servlet에서 안하고 여기서 새로 함수 만들어서 해도 되지만 귀찮으니 구냥 servlet에서 처리하자
	...
	public String update(MemberDTO m, HttpSession session) throws Exception{
//		System.out.println(dto);
